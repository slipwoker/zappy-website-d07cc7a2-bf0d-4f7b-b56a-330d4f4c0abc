document.addEventListener('DOMContentLoaded', function () {
  ...
  const navbarSelectors = ['nav', 'header', '.navbar', '[data-navbar]'];
  let navbar = null;
  ...
  if (contactForm) {
    ...
    function getOrCreateError(field) {
      ...
      let msg = parent.querySelector('.' + ERROR_MSG_CLASS);
      if (!msg) {
    ...
    function clearError(field) {
      ...
      const msg = field.parentElement.querySelector('.' + ERROR_MSG_CLASS);
    ...
    function showError(field, message) {
      ...
      const msg = getOrCreateError(field);
  ...
  const ANIMATE_CLASS = 'animate-visible';
  const ANIMATE_SELECTOR = '[data-animate], .animate-on-scroll';

  const animatableEls = Array.from(document.querySelectorAll(ANIMATE_SELECTOR));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd07cc7a2-bf0d-4f7b-b56a-330d4f4c0abc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd07cc7a2-bf0d-4f7b-b56a-330d4f4c0abc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd07cc7a2-bf0d-4f7b-b56a-330d4f4c0abc';
